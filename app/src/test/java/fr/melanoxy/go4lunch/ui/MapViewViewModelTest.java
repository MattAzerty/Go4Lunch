...
import fr.melanoxy.go4lunch.ui.MapView.MarkerInfoStateItem;
...
public class MapViewViewModelTest {
    ...
    @Test
    public void when_UserLocation_and_NearbyResults_are_not_null_should_display_MarkersNearby() throws InterruptedException {
        ...
        // When
        List<MarkerInfoStateItem> result = getOrAwaitValue(viewModel.getMarkerInfosLiveData());
//StateItems should contain 20 restaurants
    ...
    @Test
    public void when_query_and_predictions_are_not_null_should_display_MarkersAutocomplete() throws InterruptedException {
        ...
        sizeAutocompleteLiveData.setValue(3);//not used here
